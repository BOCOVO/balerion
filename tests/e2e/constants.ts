...
export const TITLE_LOGIN = 'Balerion Admin';
export const TITLE_HOME = 'Homepage | Balerion';

// TODO: we should start using @balerion.io addresses to have the chance one day to
