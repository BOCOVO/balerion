...
describe('i18n - Content API', () => {
  ...
  beforeAll(async () => {
    ...
    data.homepages = await builder.sanitizedFixturesFor(homepageModel.singularName, balerion);
    data.categories = await builder.sanitizedFixturesFor(categoryModel.singularName, balerion);
  });
