...
describe('Content Type Builder - Content types', () => {
  ...
  afterAll(async () => {
    ...
    await modelsUtils.cleanupModels(modelsUIDs, { balerion });
    await modelsUtils.deleteContentTypes(modelsUIDs, { balerion });
  ...
  describe('Collection Types', () => {
    ...
    test.each(['balerion', '_balerion', '__balerion'])(
          ...
          error: {
            details: {
              errors: [
                {
                  message:
                    'Attribute keys cannot be one of id, document_id, created_at, updated_at, published_at, created_by_id, updated_by_id, created_by, updated_by, entry_id, status, localizations, meta, locale, __component, __contentType, balerion*, _balerion*, __balerion*',
                  name: 'ValidationError',
                ...
                {
                  message:
                    'Content Type name cannot be one of boolean, date, date_time, time, upload, document, then, balerion*, _balerion*, __balerion*',
                  name: 'ValidationError',
                  path: ['contentType', 'singularName'],
                  value: 'balerion-singular',
                },
                {
                  message:
                    'Content Type name cannot be one of boolean, date, date_time, time, upload, document, then, balerion*, _balerion*, __balerion*',
