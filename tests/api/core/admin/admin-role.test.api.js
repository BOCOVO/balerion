...
describe('Role CRUD End to End', () => {
  ...
  describe('Default roles', () => {
    test('Default roles are created', async () => {
      ...
      data.superAdminRole = res.body.data.find((r) => r.code === 'balerion-super-admin');
      data.authorRole = res.body.data.find((r) => r.code === 'balerion-author');
      data.editorRole = res.body.data.find((r) => r.code === 'balerion-editor');
    });
