...
describe('Create Balerion API End to End', () => {
  beforeAll(async () => {
    await builder
  ...
  describe('Test oneToMany - manyToOne relation (article - category) with Content Manager', () => {
    ...
    afterAll(async () => {
      await modelsUtils.cleanupModels([form.article.uid, form.category.uid], { balerion });
    });
  ...
  describe('Test oneToOne relation (article - reference) with Content Manager', () => {
    ...
    afterAll(async () => {
      await modelsUtils.cleanupModels([form.article.uid, form.reference.uid], { balerion });
    });
  ...
  describe('Test oneWay relation (reference - tag) with Content Manager', () => {
    ...
    afterAll(async () => {
      await modelsUtils.cleanupModels([form.reference.uid, form.tag.uid], { balerion });
    });
