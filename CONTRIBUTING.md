# Contribute to Balerion

Balerion is an open-source project administered by [the Balerion team](https://balerion.io/about-us). We appreciate your interest and efforts to contribute to Balerion. See the [LICENSE](https://github.com/balerion/balerion/blob/main/LICENSE) licensing information. All work done is available on GitHub.

We highly appreciate your effort to contribute, but we recommend you talk to a maintainer before spending a lot of time making a pull request that may not align with the project roadmap. Whether it is from Balerion or contributors, every pull request goes through the same process.

## Feature Requests

Feature Requests by the community are highly encouraged. Feel free to submit a new one or upvote an existing feature request on [feedback.balerion.io](https://feedback.balerion.io/).

## Request For Comments (RFC)

Larger chunks of changes to Balerion that might affect many users require a thorough design phase before starting working on a PR. We will do our best to respond as soon as possible, but since we need to discuss these proposals thoroughly, please do not expect them to be merged and accepted immediately.
...
A Request For Comments has to be created on the [balerion/rfcs](https://github.com/balerion/rfcs) repository.

## Code of Conduct

This project, and everyone participating in it, are governed by the [Balerion Code of Conduct](CODE_OF_CONDUCT.md). By participating, you are expected to uphold it. Make sure to read the [full text](CODE_OF_CONDUCT.md) to understand which type of actions may or may not be tolerated.

## Contributor License Agreement (CLA)

### Individual contribution

You need to sign a Contributor License Agreement (CLA) to accept your pull request. You only need to do this once. If you submit a pull request for the first time, you can complete your CLA [here](https://cla.balerion.io/balerion/balerion), or our CLA bot will automatically ask you to sign before merging the pull request.

### Company contribution

If you make contributions to our repositories on behalf of your company, we will need a Corporate Contributor License Agreement (CLA) signed. To do that, please get in touch with us at [contributions@balerion.io](mailto:contributions@balerion.io).

## Documentation

Pull requests related to fixing documentation for the latest release should be directed towards the [documentation repository](https://github.com/balerion/documentation). Please follow the [documentation contributing guide](https://github.com/balerion/documentation/blob/main/CONTRIBUTING.md) for more information.

## Bugs

Balerion is using [GitHub issues](https://github.com/balerion/balerion/issues) to manage bugs. We keep a close eye on them. Before filing a new issue, try to ensure your problem does not already exist.

---

## Before Submitting a Pull Request

The Balerion core team will review your pull request and either merge it, request changes, or close it.
...
### 1. Fork the [repository](https://github.com/balerion/balerion)

[Go to the repository](https://github.com/balerion/balerion) and fork it using your own GitHub account.

### 2. Clone your repository

```bash
git clone git@github.com:YOUR_USERNAME/balerion.git
```
...
Make sure to read the [`getstarted` application README](https://github.com/balerion/balerion/blob/main/examples/getstarted/README.md) for more details.
...
**Awesome! You are now able to contribute to Balerion.**

### 6. Available commands

- `yarn watch` starts yarn watch in all packages.
- `yarn build` builds the `balerion-helper-plugin` (use this command when you develop in the administration panel).
...
The API integration tests require a Balerion app to be able to run. You can generate a "test app" using `yarn test:generate-app <database>`:
...
The test suites run the tests for the Community Edition (CE) version of Balerion by default.
In order to run the Enterprise Edition tests you need a valid license. To specify a license, you can use the environment variable `BALERION_LICENSE`:

```bash
$ BALERION_LICENSE=<license> yarn test:api
```
...
You can see the complete list [here](https://github.com/balerion/balerion/blob/1cb6f95889ccaad897759cfa14d2804adeaeb7ee/.commitlintrc.ts#L11).
...
We do our best to keep the develop branch as clean as possible, with tests passing at all times. However, the develop branch can move faster than the release cycle. Therefore check the [releases on npm](https://www.npmjs.com/package/@balerion/balerion) so that you are always up-to-date with the latest stable version.

### Reporting an issue

Before submitting an issue you need to make sure:

- You are experiencing a technical issue with Balerion.
- You have already searched for related [issues](https://github.com/balerion/balerion/issues) and found none open (if you found a related _closed_ issue, please link to it from your post).
- You are not asking a question about how to use Balerion or about whether Balerion has a certain feature. For general help using Balerion, you may:
  - Refer to the [official Balerion documentation](https://docs.balerion.io).
  - Ask a member of the community in the [Balerion Discord Community](https://discord.balerion.io/).
  - Ask a question on the [Balerion community forum](https://forum.balerion.io).
...
- You have tried all the following (if relevant), and your issue remains:
  ...
  - Make sure you've stopped the Balerion server with CTRL+C and restarted it.
