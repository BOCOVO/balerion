...
// Needed to load global.balerion without having to put @balerion/types in the regular dependencies
import type {} from '@balerion/types';
...
export default {
  init({ sizeLimit: providerOptionsSizeLimit }: InitOptions = {}) {
    ...
    const uploadPath = path.resolve(balerion.dirs.static.public, UPLOADS_FOLDER_NAME);
