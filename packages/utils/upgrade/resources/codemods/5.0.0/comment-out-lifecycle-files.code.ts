 ...
 * CONTEXT:
 *
 * The lifecycles.js file has been commented out to prevent unintended side effects when starting Balerion 5 for the first time after migrating to the document service.
 *
 * BALERION 5 introduces a new document service that handles lifecycles differently compared to previous versions. Without migrating your lifecycles to document service middlewares, you may experience issues such as:
 *
 ...
 * [Document Services Middlewares Migration Guide](https://docs.balerion.io/dev-docs/migration/v4-to-v5/breaking-changes/lifecycle-hooks-document-service)
 *
 * IMPORTANT:
 *
