...
By default, when executed on a Balerion application project, it offers codemods matching the current major version of the app.
When executed on a Balerion plugin project, it shows every codemods.
`
    )
