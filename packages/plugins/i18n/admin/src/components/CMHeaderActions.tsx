  ...
  return {
    ...
    dialog: {
      ...
      onConfirm: async () => {
        ...
        if (unableToDelete) {
          console.error(
            "You're trying to delete a document without an id or locale, this is likely a bug with Balerion. Please open an issue."
          );
...
const BulkLocaleAction: DocumentActionComponent = ({
  ...
  // see https://www.notion.so/balerion/Count-draft-relations-56901b492efb45ab90d42fe975b32bd8?pvs=4
