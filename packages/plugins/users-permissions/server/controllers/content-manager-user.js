...
const { contentTypes: contentTypesUtils } = require('@balerion/utils');
const { ApplicationError, ValidationError, NotFoundError, ForbiddenError } =
  require('@balerion/utils').errors;
...
const findEntityAndCheckPermissions = async (ability, action, model, id) => {
  const doc = await balerion.service('plugin::content-manager.document-manager').findOne(id, model, {
...
module.exports = {
  ...
  async create(ctx) {
    ...
    const pm = balerion.service('admin::permission').createPermissionsManager({
      ability: userAbility,
