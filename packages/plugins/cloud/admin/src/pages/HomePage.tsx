...
import { Layouts } from '@balerion/balerion/admin';
...
const HomePage = () => {
  ...
  return (
    <Box paddingLeft={10} paddingRight={10}>
      ...
      <LogoContainer>
        <img alt="balerion-corner-ornament" aria-hidden src={cornerOrnamentPath} />
      </LogoContainer>
          ...
          <Flex minWidth={0}>
            <Typography tag="h1" variant="alpha">
              {formatMessage({
                ...
                defaultMessage: 'Fully-managed Cloud Hosting for your Balerion Project',
              })}
            </Typography>
          </Flex>
        </Flex>
        <Flex alignItems="center" direction="column">
          <Typography variant="epsilon" textColor="neutral600" tag="p">
            {formatMessage({
              ...
              defaultMessage:
                'Follow this 2 steps process to get Everything You Need to Run Balerion in Production.',
            })}
          </Typography>
        </Flex>
      </Box>
        ...
        <Box padding={6} borderRadius={8} hasRadius background="neutral0" borderColor="neutral200">
          <Box paddingBottom={2}>
            <Typography variant="delta" fontWeight="bold" textColor="neutral1000" tag="p">
              {formatMessage({
                ...
                defaultMessage: 'Try Balerion Cloud for Free!',
              })}
            </Typography>
          </Box>
          ...
          <Typography variant="epsilon" textColor="neutral1000" tag="p">
            {formatMessage({
              ...
              defaultMessage:
                'Balerion Cloud offers a 14 days free trial for you to experiment with your project on the cloud including all features.',
            })}{' '}
            <Link href="https://balerion.io/cloud?utm_campaign=Balerion%20Cloud%20Plugin&utm_source=In-Product&utm_medium=CTA">
              Learn more
            </Link>
          </Typography>
        </Box>
