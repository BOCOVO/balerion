      ...
      <Flex alignItems="center" direction="column" padding={11} hasRadius>
        ...
        <Box paddingBottom={4}>
          <Typography variant="beta" tag="p" textAlign="center" textColor="neutral1000">
            {formatMessage({
              ...
              defaultMessage: 'Deploy to Balerion Cloud',
            })}
          </Typography>
        </Box>
        <Typography variant="epsilon" tag="p" textAlign="center" textColor="neutral600">
          {formatMessage({
            ...
            defaultMessage:
              'Enjoy a Balerion-optimized stack including database, email provider, and CDN.',
          })}
        </Typography>
        <Box marginTop={4}>
          <LinkButton
            ...
            href="https://cloud.balerion.io/login?utm_campaign=Balerion%20Cloud%20Plugin&utm_source=In-Product&utm_medium=CTA"
            isExternal
            target="_blank"
          >
            {formatMessage({
