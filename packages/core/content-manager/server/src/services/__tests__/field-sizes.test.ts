...
describe('field sizes service', () => {
  it('should return the correct field sizes', () => {
    const { getAllFieldSizes } = createFieldSizesService({ balerion });
  ...
  it('should return the correct field size for a given type', () => {
    const { getFieldSize } = createFieldSizesService({ balerion });
  ...
  it('should set the custom fields input sizes', () => {
    const { setCustomFieldInputSizes, getAllFieldSizes } = createFieldSizesService({ balerion });
