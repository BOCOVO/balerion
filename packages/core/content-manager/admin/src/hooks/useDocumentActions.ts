 ...
 * Designed to be able to be used anywhere within a Balerion app. The hooks will handle
 ...
 * @example
 * ```tsx
 * import { Form } from '@balerion/admin/admin';
 *
 ...
 * ```
 *
 * @see {@link https://contributor.balerion.io/docs/core/content-manager/hooks/use-document-operations} for more information
 */
