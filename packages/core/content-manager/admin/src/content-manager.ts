...
import type { DescriptionComponent, PluginConfig } from '@balerion/admin/balerion-admin';
...
interface PanelComponent extends DescriptionComponent<PanelComponentProps, PanelDescription> {
  /**
   * The defaults are added by Balerion only, if you're providing your own component,
