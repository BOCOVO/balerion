...
const HeaderToolbar = () => {
  ...
  const plugins = useBalerionApp('HeaderToolbar', (state) => state.plugins);
      ...
      onConfirm: async () => {
        ...
        try {
          if (!documentId && collectionType !== SINGLE_TYPES) {
            console.error(
              "You're trying to delete a document without an id, this is likely a bug with Balerion. Please open an issue."
            );
