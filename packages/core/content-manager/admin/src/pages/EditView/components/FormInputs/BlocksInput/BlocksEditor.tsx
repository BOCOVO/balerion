...
import { createContext, type FieldValue } from '@balerion/admin/balerion-admin';
...
import { withBalerionSchema } from './plugins/withBalerionSchema';
...
const BlocksEditor = React.forwardRef<{ focus: () => void }, BlocksEditorProps>(
  ({ disabled = false, name, onChange, value, error, ...contentProps }, forwardedRef) => {
    ...
    const [editor] = React.useState(() =>
      pipe(withHistory, withImages, withBalerionSchema, withReact, withLinks)(createEditor())
    );
