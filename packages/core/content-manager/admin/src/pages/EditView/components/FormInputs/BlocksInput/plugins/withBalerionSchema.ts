...
/**
 * This plugin is used to normalize the Slate document to match the Balerion schema.
 */
const withBalerionSchema = (editor: Editor) => {
  const { normalizeNode } = editor;

  /**
   * On the balerion schema, we want text nodes to have type: text
