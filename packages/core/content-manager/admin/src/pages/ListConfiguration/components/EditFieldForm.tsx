import { Form, useField, InputRenderer, useNotification } from '@balerion/admin/balerion-admin';
...
const EditFieldForm = ({ attribute, name, onClose }: EditFieldFormProps) => {
  ...
  if (!value) {
    ...
    console.error(
      "You've opened a field to edit without it being part of the form, this is likely a bug with Balerion. Please open an issue."
    );
