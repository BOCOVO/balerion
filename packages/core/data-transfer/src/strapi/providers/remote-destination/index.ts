...
import type { ILocalBalerionDestinationProviderOptions } from '../local-destination';
...
class RemoteBalerionDestinationProvider implements IDestinationProvider {
  name = 'destination::remote-balerion';

  type: ProviderType = 'destination';

  options: IRemoteBalerionDestinationProviderOptions;
  ...
  constructor(options: IRemoteBalerionDestinationProviderOptions) {
...
export const createRemoteBalerionDestinationProvider = (
  options: IRemoteBalerionDestinationProviderOptions
) => {
  return new RemoteBalerionDestinationProvider(options);
};
