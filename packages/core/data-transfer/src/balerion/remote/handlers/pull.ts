...
import { createLocalBalerionSourceProvider, ILocalBalerionSourceProvider } from '../../providers';
...
export interface PullHandler extends Handler {
  provider?: ILocalBalerionSourceProvider;
...
export const createPullController = handlerControllerFactory<Partial<PullHandler>>((proto) => ({
  ...
  async init(this: PullHandler) {
    ...
    this.provider = createLocalBalerionSourceProvider({
      autoDestroy: false,
