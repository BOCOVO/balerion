...
import type { Database, Migration } from '@balerion/database';
...
const migrateUp = async (trx: Knex, db: Database) => {
   ...
   *       E.g. @see https://github.com/balerion/balerion/issues/21583
   */
  const documentService = createDocumentService(balerion, {
