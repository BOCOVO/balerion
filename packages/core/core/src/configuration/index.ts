...
import { version as balerionVersion } from '../../package.json';
...
export const loadConfiguration = (opts: BalerionOptions) => {
  ...
  const rootConfig = {
    ...
    uuid: _.get(pkgJSON, 'balerion.uuid'),
    packageJsonBalerion: _.omit(_.get(pkgJSON, 'balerion', {}), 'uuid'),
    info: {
      ...pkgJSON,
      balerion: balerionVersion,
    },
    admin: {
      serveAdminPanel,
    },
