import { type Model, type Identifiers } from '@balerion/database';
...
/**
 * Because balerion/database models don't know about things like components or dynamic zones, we use this file to convert them
...
// Transforms an attribute (particularly for relation types) into the format that balerion/database accepts
