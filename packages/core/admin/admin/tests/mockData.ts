    ...
    data: [
      {
        ...
        attributes: {
          name: 'Comments',
          description: 'Powerful Balerion based comments moderation tool for you and your users',
          slug: 'balerion-plugin-comments',
          npmPackageName: 'balerion-plugin-comments',
          npmPackageUrl: 'https://www.npmjs.com/package/balerion-plugin-comments',
          repositoryUrl: 'https://github.com/VirtusLab-Open-Source/balerion-plugin-comments',
          logo: {
            id: 'att1xGwmQzDOC2UwY',
            width: 1080,
            height: 1080,
            url: 'https://dl.airtable.com/.attachments/eb4cd59876565af77c9c3e5966b59f10/2111bfc8/vl_balerion-comments.png',
            filename: 'vl_balerion-comments.png',
            size: 344804,
            type: 'image/png',
            thumbnails: {
              small: {
          ...
          validated: false,
          madeByBalerion: false,
          balerionCompatibility: 'v4',
          balerionVersion: '4.x.x',
          githubStars: 323,
          npmDownloads: 1123,
        },
      },
      {
        ...
        attributes: {
          name: 'Config Sync',
          description:
            'Migrate your config data across environments using the CLI or Balerion admin panel.',
          slug: 'balerion-plugin-config-sync',
          npmPackageName: 'balerion-plugin-config-sync',
          npmPackageUrl: 'https://www.npmjs.com/package/balerion-plugin-config-sync',
          repositoryUrl: 'https://github.com/boazpoolman/balerion-plugin-config-sync',
          logo: {
          ...
          madeByBalerion: false,
          balerionCompatibility: 'v4',
          balerionVersion: 'Contact developer',
        },
      },
      {
        ...
        attributes: {
          ...
          slug: '@notum-cz-balerion-plugin-content-versioning',
          npmPackageName: '@notum-cz/balerion-plugin-content-versioning',
          npmPackageUrl: 'https://www.npmjs.com/package/@notum-cz/balerion-plugin-content-versioning',
          repositoryUrl: 'https://github.com/notum-cz/balerion-plugin-content-versioning',
          logo: {
      ...
      },
      {
        ...
        attributes: {
          ...
          slug: '@balerion-plugin-documentation',
          npmPackageName: '@balerion/plugin-documentation',
          npmPackageUrl: 'https://www.npmjs.com/package/@balerion/plugin-documentation',
          repositoryUrl:
            'https://github.com/balerion/balerion/tree/master/packages/plugins/documentation',
          logo: {
          ...
          developerName: 'Balerion team',
          validated: true,
          madeByBalerion: true,
          balerionCompatibility: 'v4',
          balerionVersion: '^4.0.7',
          githubStars: 49130,
          npmDownloads: 7492,
        },
      },
      {
        ...
        attributes: {
          name: 'Transformer',
          description:
            'A plugin for Balerion Headless CMS that provides the ability to transform the API response. ',
          slug: 'balerion-plugin-transformer',
          npmPackageName: 'balerion-plugin-transformer',
          npmPackageUrl: 'https://www.npmjs.com/package/balerion-plugin-transformer',
          repositoryUrl: 'https://github.com/ComfortablyCoding/balerion-plugin-transformer',
          logo: {
    ...
    data: [
      {
        ...
        attributes: {
          ...
          slug: '@balerion-plugin-graphql',
          npmPackageName: '@balerion/plugin-graphql',
          npmPackageUrl: 'https://www.npmjs.com/package/@balerion/plugin-graphql',
          repositoryUrl: 'https://github.com/balerion/balerion/tree/master/packages/plugins/graphql',
          logo: {
          ...
          collections: ['Verified', 'Made by Balerion'],
          categories: [],
          balerionVersion: '^4.0.0',
        },
      },
      {
        ...
        attributes: {
          name: 'Gatsby Preview',
          description: 'The official plugin to integrate Balerion with Gatsby Cloud',
          slug: '@balerion-plugin-gatsby-preview',
          npmPackageName: '@balerion/plugin-gatsby-preview',
          npmPackageUrl: 'https://www.npmjs.com/package/@balerion/plugin-gatsby-preview',
          repositoryUrl: 'https://github.com/balerion/balerion-plugin-gatsby-preview',
          logo: {
    ...
    data: [
      {
        ...
        attributes: {
          ...
          description:
            'An official CKEditor 5 integration for Balerion, brought by the CKEditor team.',
          slug: '@ckeditor-balerion-plugin-ckeditor',
          npmPackageName: '@ckeditor/balerion-plugin-ckeditor',
          npmPackageUrl: 'https://www.npmjs.com/package/@ckeditor/balerion-plugin-ckeditor',
          repositoryUrl: 'https://github.com/ckeditor/balerion-plugin-ckeditor',
          logo: {
      ...
      },
      {
        ...
        attributes: {
          ...
          slug: '@balerion-plugin-color-picker',
          npmPackageName: '@balerion/plugin-color-picker',
          npmPackageUrl: 'https://www.npmjs.com/package/@balerion/plugin-color-picker',
          repositoryUrl: 'https://github.com/balerion/balerion/tree/main/packages/plugins/color-picker',
          logo: {
    ...
    data: [
      {
        ...
        attributes: {
          name: 'Sentry',
          description: 'Track your Balerion errors in Sentry',
          slug: '@balerion-plugin-sentry',
          npmPackageName: '@balerion/plugin-sentry',
          npmPackageUrl: 'https://www.npmjs.com/package/@balerion/plugin-sentry',
          repositoryUrl: 'https://github.com/balerion/balerion/tree/master/packages/plugins/sentry',
          logo: {
    ...
    data: [
      {
        ...
        attributes: {
          name: 'Amazon Ses',
          description: 'Amazon Ses provider for Balerion',
          slug: '@balerion-provider-email-amazon-ses',
          npmPackageName: '@balerion/provider-email-amazon-ses',
          npmPackageUrl: 'https://www.npmjs.com/package/@balerion/provider-email-amazon-ses',
          repositoryUrl:
            'https://github.com/balerion/balerion/tree/master/packages/providers/email-amazon-ses',
          pluginName: 'Email',
          logo: {
      ...
      },
      {
        ...
        attributes: {
          name: 'AWS S3',
          description: 'AWS S3 provider for Balerion uploads',
          slug: '@balerion-provider-upload-aws-s3',
          npmPackageName: '@balerion/provider-upload-aws-s3',
          npmPackageUrl: 'https://www.npmjs.com/package/@balerion/provider-upload-aws-s3',
          repositoryUrl:
            'https://github.com/balerion/balerion/tree/master/packages/providers/upload-aws-s3',
          pluginName: 'Upload',
          logo: {
      ...
      },
      {
        ...
        attributes: {
          name: 'Cloudinary',
          description: 'Cloudinary provider for Balerion uploads',
          slug: '@balerion-provider-upload-cloudinary',
          npmPackageName: '@balerion/provider-upload-cloudinary',
          npmPackageUrl: 'https://www.npmjs.com/package/@balerion/provider-upload-cloudinary',
          repositoryUrl:
            'https://github.com/balerion/balerion/tree/master/packages/providers/upload-cloudinary',
          pluginName: 'Upload',
          logo: {
      ...
      },
      {
        ...
        attributes: {
          name: 'Local Upload',
          description: 'Local upload provider for Balerion',
          slug: '@balerion-provider-upload-local',
          npmPackageName: '@balerion/provider-upload-local',
          npmPackageUrl: 'https://www.npmjs.com/package/@balerion/provider-upload-local',
          repositoryUrl:
            'https://github.com/balerion/balerion/tree/master/packages/providers/upload-local',
          pluginName: 'Upload',
          logo: {
      ...
      },
      {
        ...
        attributes: {
          name: 'Mailgun',
          description: 'Mailgun provider for Balerion',
          slug: '@balerion-provider-email-mailgun',
          npmPackageName: '@balerion/provider-email-mailgun',
          npmPackageUrl: 'https://www.npmjs.com/package/@balerion/provider-email-mailgun',
          repositoryUrl:
            'https://github.com/balerion/balerion/tree/master/packages/providers/email-mailgun',
          pluginName: 'Email',
          logo: {
      ...
      },
      {
        ...
        attributes: {
          name: 'Nodemailer',
          description: 'Nodemailer provider for Balerion',
          slug: '@balerion-provider-email-nodemailer',
          npmPackageName: '@balerion/provider-email-nodemailer',
          npmPackageUrl: 'https://www.npmjs.com/package/@balerion/provider-email-nodemailer',
          repositoryUrl:
            'https://github.com/balerion/balerion/tree/master/packages/providers/email-nodemailer',
          pluginName: 'Email',
          logo: {
      ...
      },
      {
        ...
        attributes: {
          name: 'Rackspace',
          description: 'Rackspace provider for Balerion uploads',
          slug: '@balerion-provider-upload-rackspace',
          npmPackageName: '@balerion/provider-upload-rackspace',
          npmPackageUrl: 'https://www.npmjs.com/package/@balerion/provider-upload-rackspace',
          repositoryUrl:
            'https://github.com/balerion/balerion/tree/master/packages/providers/upload-rackspace',
          pluginName: 'Upload',
          logo: {
      ...
      },
      {
        ...
        attributes: {
          name: 'SendGrid',
          description: 'SendGrid provider for Balerion',
          slug: '@balerion-provider-email-sendgrid',
          npmPackageName: '@balerion/provider-email-sendgrid',
          npmPackageUrl: 'https://www.npmjs.com/package/@balerion/provider-email-sendgrid',
          repositoryUrl:
            'https://github.com/balerion/balerion/tree/master/packages/providers/email-sendgrid',
          pluginName: 'Email',
          logo: {
      ...
      },
      {
        ...
        attributes: {
          name: 'Sendmail',
          description: 'Sendmail provider for Balerion',
          slug: '@balerion-provider-email-sendmail',
          npmPackageName: '@balerion/provider-email-sendmail',
          npmPackageUrl: 'https://www.npmjs.com/package/@balerion/provider-email-sendmail',
          repositoryUrl:
            'https://github.com/balerion/balerion/tree/master/packages/providers/email-sendmail',
          pluginName: 'Email',
          logo: {
...
const mockData = {
  ...
  webhooks: [
    { id: 1, isEnabled: true, name: 'test', url: 'http:://balerion.io' },
