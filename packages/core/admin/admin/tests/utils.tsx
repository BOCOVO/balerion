...
import { fixtures } from '@balerion/admin-test-utils';
...
import { BalerionAppProvider } from '../src/features/BalerionApp';
                          ...
                          <GuidedTourProvider>
                            ...
                            >
                              <AppInfoProvider
                                ...
                                useYarn
                                dependencies={{
                                  '@balerion/plugin-documentation': '4.2.0',
                                  '@balerion/provider-upload-cloudinary': '4.2.0',
                                }}
                                balerionVersion="4.1.0"
                                communityEdition
                                shouldUpdateBalerion={false}
                              >
                                {children}
                              </AppInfoProvider>
                            </ConfigurationContextProvider>
 ...
 * for use of testing components within the Balerion Admin.
 */
const render = (
 ...
 * for use of testing hooks within the Balerion Admin.
 */
const renderHook = <
  Result,
  Props,
