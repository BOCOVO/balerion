...
const MarketplacePage = () => {
  ...
  const {
    ...
    possibleCategories,
    pagination,
  } = useMarketplaceData({ npmPackageType, debouncedSearch, query, tabQuery, balerionVersion });
          ...
          <Tabs.Root variant="simple" onValueChange={handleTabChange} value={npmPackageType}>
            <Flex justifyContent="space-between" paddingBottom={4}>
              <Tabs.List
                aria-label={formatMessage({
                  ...
                  defaultMessage: 'Plugins and Providers for Balerion',
                })}
              >
            ...
            <Tabs.Content value={PLUGIN}>
              <NpmPackagesGrid
                ...
                balerionAppVersion={balerionVersion}
            ...
            <Box paddingTop={8}>
              <a
                href="https://balerion.canny.io/plugin-requests"
                target="_blank"
