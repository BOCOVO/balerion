            ...
            <Grid.Item col={6} s={12}>
              <Flex direction="column" alignItems="flex-start" padding={7} gap={2}>
                ...
                <Flex gap={2} marginTop={7}>
                  <LinkButton
                    variant="default"
                    href="https://balerion.io/pricing-self-hosted?utm_campaign=In-Product-CTA&utm_source=Content-History"
                  >
                    {formatMessage({
                  ...
                  <LinkButton
                    ...
                    href="https://balerion.io/features/content-history?utm_campaign=In-Product-CTA&utm_source=Content-History"
                  >
                    {formatMessage({
