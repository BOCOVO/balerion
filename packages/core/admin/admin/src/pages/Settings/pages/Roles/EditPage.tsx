...
const EditPage = () => {
  ...
  const handleEditRoleSubmit = async (
    ...
    try {
      ...
      if (role.code !== 'balerion-super-admin' && permissionsToSend) {
  ...
  const isFormDisabled = !isRoleLoading && role.code === 'balerion-super-admin';
              ...
              primaryAction={
                <Flex gap={2}>
                  <Button
                    type="submit"
                    startIcon={<Check />}
                    disabled={role.code === 'balerion-super-admin'}
