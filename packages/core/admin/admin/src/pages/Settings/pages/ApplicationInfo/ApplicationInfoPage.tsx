...
const ApplicationInfoPage = () => {
  ...
  const latestBalerionReleaseTag = useAppInfo(
    'ApplicationInfoPage',
                ...
                <Grid.Root gap={5} tag="dl">
                  <Grid.Item col={6} s={12} direction="column" alignItems="start">
                    <Typography variant="sigma" textColor="neutral600" tag="dt">
                      {formatMessage({
                        id: 'Settings.application.balerionVersion',
                        defaultMessage: 'balerion version',
                      })}
                    </Typography>
                    <Flex gap={3} direction="column" alignItems="start" tag="dd">
                      <Typography>v{balerionVersion}</Typography>
                      {shouldUpdateBalerion && (
                        <Link
                          href={`https://github.com/balerion/balerion/releases/tag/${latestBalerionReleaseTag}`}
