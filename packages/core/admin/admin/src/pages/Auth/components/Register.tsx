...
const Register = ({ hasAdmin }: RegisterProps) => {
  ...
  const handleRegisterAdmin = async (
    ...
    if ('data' in res) {
      ...
      if (roles) {
        const isUserSuperAdmin = roles.find(({ code }) => code === 'balerion-super-admin');
        ...
        <Flex direction="column" alignItems="center" gap={3}>
          ...
          <Typography tag="h1" variant="alpha" textAlign="center">
            {formatMessage({
              ...
              defaultMessage: 'Welcome to Balerion!',
            })}
          </Typography>
          <Typography variant="epsilon" textColor="neutral600" textAlign="center">
            {formatMessage({
              ...
              defaultMessage:
                'Credentials are only used to authenticate in Balerion. All saved data will be stored in your database.',
            })}
          </Typography>
          {apiError ? (
              ...
              {[
                ...
                },
                {
                  label: formatMessage(
                    ...
                    {
                      terms: (
                        <A target="_blank" href="https://balerion.io/terms" rel="noreferrer">
                          {formatMessage({
                      ...
                      policy: (
                        <A target="_blank" href="https://balerion.io/privacy" rel="noreferrer">
                          {formatMessage({
