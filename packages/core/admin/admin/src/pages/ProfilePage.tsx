...
const ProfilePage = () => {
  ...
  const {
    ...
    skip: !(window.balerion.isEE && window.balerion.features.isEnabled('sso')),
  });
              ...
              },
              {
                here: (
                  <Box
                    ...
                    href="https://docs.balerion.io/developer-docs/latest/development/admin-customization.html#locales"
                  >
                    {formatMessage({
