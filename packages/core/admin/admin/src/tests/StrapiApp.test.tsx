...
describe('ADMIN | new BalerionApp', () => {
  ...
  describe('Settings api', () => {
    ...
    it('should warn if a user supplies an absolute link', () => {
      ...
      expect(consoleSpy.mock.calls[0]).toMatchInlineSnapshot(`
        [
          "[bar]: the \`to\` property of your settings link is an absolute path. It should be relative to \`/settings\`. This has been corrected for you but will be removed in a future version of Balerion.",
        ]
      `);
  ...
  describe('Menu api', () => {
    ...
    it('should warn if a user supplies an absolute link', () => {
      ...
      expect(consoleSpy.mock.calls[0]).toMatchInlineSnapshot(`
        [
          "[bar]: the \`to\` property of your menu link is an absolute path, it should be relative to the root of the application. This has been corrected for you but will be removed in a future version of Balerion.",
        ]
      `);
  ...
  describe('createCustomConfigurations', () => {
    ...
    it('should override the light theme', () => {
      ...
      const app = new BalerionApp({ config: { theme: { light: { colors: { red: 'black' } } } } });
    ...
    it('should override the dark theme', () => {
      // @ts-expect-error - test mocks
      const app = new BalerionApp({ config: { theme: { dark: { colors: { red: 'black' } } } } });
    ...
    it('should override the light theme with a legacy syntax (without light or dark keys) and log a warning', () => {
      ...
      // @ts-expect-error - test mocks
      const app = new BalerionApp({ config: { theme: { colors: { red: 'black' } } } });
    ...
    it('should override the tutorials', () => {
      const app = new BalerionApp({ config: { tutorials: false } });

      expect(app.configurations.tutorials).toBeFalsy();
    });

    it('should override the release notification', () => {
      const app = new BalerionApp({ config: { notifications: { releases: false } } });
