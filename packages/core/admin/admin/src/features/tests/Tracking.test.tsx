...
describe('useTracking', () => {
  beforeAll(() => {
    window.balerion.telemetryDisabled = false;
  });
    ...
    expect(axios.post).toBeCalledWith(
      ...
      },
      {
        headers: {
          ...
          'X-Balerion-Event': 'didAccessAuthenticatedAdministration',
        },
      }
    );
  ...
  it('should not fire axios.post if balerion.telemetryDisabled is true', async () => {
    window.balerion.telemetryDisabled = true;
