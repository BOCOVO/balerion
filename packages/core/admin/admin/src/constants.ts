...
import type { BalerionAppSettingLink } from './core/apis/router';
...
export interface SettingsMenuLink
  extends Omit<BalerionAppSettingLink, 'Component' | 'permissions' | 'licenseOnly'> {
  licenseOnly?: boolean;
}
...
export const SETTINGS_LINKS_CE = (): SettingsMenu => ({
  global: [
    ...
    ...(!window.balerion.features.isEnabled(window.balerion.features.SSO) &&
    window.balerion?.flags?.promoteEE
      ? [
          {
      ...
      : []),
    ...(!window.balerion.features.isEnabled('cms-content-history') && window.balerion?.flags?.promoteEE
      ? [
          {
  ...
  admin: [
    ...
    ...(!window.balerion.features.isEnabled(window.balerion.features.AUDIT_LOGS) &&
    window.balerion?.flags?.promoteEE
      ? [
          {
