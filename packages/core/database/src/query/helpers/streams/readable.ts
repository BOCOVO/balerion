...
interface ReadableBalerionQueryOptions {
  qb: QueryBuilder;
  uid: string;
  db: Database;
  mapResults?: boolean;
...
class ReadableBalerionQuery extends Readable {
  _offset: number;
  ...
  constructor({ qb, db, uid, mapResults = true, batchSize = 500 }: ReadableBalerionQueryOptions) {
...
export default ReadableBalerionQuery;
