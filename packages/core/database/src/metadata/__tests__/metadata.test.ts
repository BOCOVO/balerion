      ...
      describe('relation conversion', () => {
        describe('error cases', () => {
          test('throws error on duplicate table name', () => {
            const badModels = [
              {
                uid: 'balerion::core-store',
                collectionName: 'balerion_core_store_settings',
                attributes: {
                  key: {
                    type: 'string',
                  },
                },
                tableName: 'balerion_core_store_settings',
              },
              {
                uid: 'balerion::test',
                collectionName: 'balerion_test',
                attributes: {
                  key: {
                    type: 'string',
                  },
            ...
            expect(() => createMetadata(badModels)).toThrow(
              'DB table "balerion_core_store_settings" already exists. Change the collectionName of the related content type'
            );
          });
          ...
          test('throws error on missing relation uid', () => {
            ...
            expect(() => createMetadata(badModels)).toThrow(
              'Error on attribute role in model undefined(balerion::core-store): Metadata for "admin::role" not found'
            );
          });
          ...
          test('throws error on invalid relation', () => {
            ...
            expect(() => createMetadata(badModels)).toThrow(
              'Error on attribute role in model undefined(balerion::core-store): Unknown relation'
            );
          });
          ...
          test('throws error on missing attribute inversedBy attribute', () => {
            ...
            expect(() => createMetadata(badModels)).toThrow(
              'Error on attribute role in model undefined(balerion::core-store): inversedBy attribute permissions not found target balerion::core-store'
            );
          });
          ...
          test('throws error on missing attribute inversedBy attribute', () => {
            ...
            expect(() => createMetadata(badModels)).toThrow(
              'Error on attribute role in model undefined(balerion::core-store): inversedBy attribute permissions targets non relational attribute in balerion::core-store'
            );
          });
          ...
          test('throws error on missing target', () => {
            ...
            expect(() => createMetadata(badModels)).toThrow(
              'Error on attribute role in model undefined(balerion::core-store): Metadata for "missingtarget" not found'
            );
          });
        });
      });
