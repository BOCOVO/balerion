...
import { DefaultDocument } from '@balerion/admin/_internal';
...
const getEntryModule = (ctx: BuildContext): string => {
  ...
  return outdent`
        /**
         * This file was automatically generated by Balerion.
         * Any modifications made will be discarded.
         */
        ${pluginsImport}
        import { renderAdmin } from "@balerion/balerion/admin"
        ...
        renderAdmin(
          document.getElementById("balerion"),
          {
...
const writeStaticClientFiles = async (ctx: BuildContext) => {
  ...
  /**
   * For everything to work effectively we create a client folder in `.balerion` at the cwd level.
