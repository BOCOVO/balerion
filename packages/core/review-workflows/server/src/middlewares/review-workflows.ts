...
/**
 * A Balerion middleware function that adds support for review workflows.
 *
 * Why is it needed ?
 ...
 *
 * @param {object} balerion - The Balerion instance.
 */
export function contentTypeMiddleware(balerion: Core.Balerion) {
  /**
  ...
  balerion.server.router.use('/content-type-builder/content-types/:uid?', (ctx, next) => {
