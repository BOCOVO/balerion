 ...
 *
 * NOTE!: if you change this string you need to change it here too: balerion/packages/core/review-workflows/admin/src/routes/settings/components/Stages.tsx
 */
export const STAGE_TRANSITION_UID = 'admin::review-workflows.stage.transition';

export const STAGE_DEFAULT_COLOR = '#4945FF';
export const ENTITY_STAGE_ATTRIBUTE = 'balerion_stage';
export const ENTITY_ASSIGNEE_ATTRIBUTE = 'balerion_assignee';
