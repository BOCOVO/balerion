import { SanitizedAdminUser } from '@balerion/admin/balerion-admin';
...
const StageColumn = (props: StageColumnProps) => {
  const { color = STAGE_COLOR_DEFAULT, name } = props.balerion_stage ?? {};
...
const AssigneeColumn = (props: AssigneeColumnProps) => {
  const { balerion_assignee: user } = props;
