import { Layouts } from '@balerion/admin/balerion-admin';
            ...
            <Grid.Item col={6} s={12}>
              <Flex direction="column" alignItems="flex-start" padding={7} gap={2}>
                ...
                <Flex gap={2} marginTop={7}>
                  <LinkButton
                    variant="default"
                    href="https://balerion.io/pricing-self-hosted?utm_campaign=In-Product-CTA&utm_source=Review%20Workflows"
                  >
                    {formatMessage({
                  ...
                  <LinkButton
                    ...
                    href="https://balerion.io/features/review-workflow?utm_campaign=In-Product-CTA&utm_source=Review%20Workflows"
                  >
                    {formatMessage({
