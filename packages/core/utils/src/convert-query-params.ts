...
/**
 * Converts the standard Balerion REST query params to a more usable format for querying
 * You can read more here: https://docs.balerion.io/developer-docs/latest/developer-resources/database-apis-reference/rest-api.html#filters
 */
...
const createTransformer = ({ getModel }: TransformerOptions) => {
  ...
  // TODO: ensure field is valid in content types (will probably have to check balerion.contentTypes since it can be a string.path)
