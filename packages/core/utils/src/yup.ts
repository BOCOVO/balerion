...
export const balerionID = (): InstanceType<typeof BalerionIDSchema> => new BalerionIDSchema();
...
export class BalerionIDSchema extends yup.MixedSchema {
  constructor() {
    super({ type: 'balerionID' });
  }
...
declare module 'yup' {
  // const balerionID: () => InstanceType<typeof BalerionIDSchema>;
