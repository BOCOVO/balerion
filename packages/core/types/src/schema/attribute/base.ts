/**
 * Enumerates all possible attribute types in Balerion.
 *
...
export interface Attribute<TKind extends Kind = Kind> {
   ...
   * https://docs.balerion.io/dev-docs/backend-customization/models#database-validations-and-settings
   *
   * @experimental
...
// NOTE: Copied directly from @balerion/database package
