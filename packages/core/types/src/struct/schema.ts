...
/**
 * A loaded instance of a Balerion Schema accessible to the server.
 */
export interface BaseSchema {
  ...
  /**
   * Encapsulates all core options related to Balerion features for a given Schema.
   */
...
export interface SchemaInfo {
   ...
   * recognition and improves navigation. The value should be any valid @balerion/icon name. This
 ...
 *
 * These keys and values define the structure and characteristics of a Balerion schema.
 */
export type SchemaAttributes = Record<string, Attribute.AnyAttribute>;

/**
 * Contains various options employed during runtime to tweak certain aspects of Balerion features.
 *
...
/**
 * Provides a flexible configuration method for Balerion plugins.
 *
 * In Balerion, plugins extend the core functionality and enhance features of the application. Each plugin may require
 ...
 *
 * const balerionPluginOptions: Struct.SchemaPluginOptions = {
 *   'plugin-foo': {
 *     prop1: string;
 *     prop2: boolean;
 *   },
 ...
 *   modelName: 'Article',
 *   globalId: 'Article',
 *   pluginOptions: balerionPluginOptions,
