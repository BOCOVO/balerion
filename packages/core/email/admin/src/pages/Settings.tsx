...
import { Page, useNotification, useFetchClient, Layouts } from '@balerion/admin/balerion-admin';
import {
  Box,
  Button,
  Flex,
                    ...
                    <Typography>
                      {formatMessage(
                        ...
                        },
                        {
                          ...
                          link: (
                            <DocumentationLink
                              href="https://docs.balerion.io/developer-docs/latest/plugins/email.html"
                              target="_blank"
                      ...
                      <Field.Root name="shipper-email">
                        ...
                        <TextInput
                          placeholder={formatMessage({
                            ...
                            defaultMessage: "ex: Balerion No-Reply '<'no-reply@balerion.io'>'",
                          })}
                          disabled
                      ...
                      <Field.Root name="response-email">
                        ...
                        <TextInput
                          placeholder={formatMessage({
                            ...
                            defaultMessage: `ex: Balerion '<'example@balerion.io'>'`,
                          })}
                          disabled
