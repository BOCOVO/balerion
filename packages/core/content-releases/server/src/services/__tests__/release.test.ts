...
describe('Release service', () => {
  describe('update', () => {
    ...
    it('updates the release', async () => {
      ...
      const releaseService = createReleaseService({ balerion: balerionMock });
  ...
  describe('publish', () => {
    it('throws an error if the release does not exist', () => {
      ...
      // @ts-expect-error Ignore missing properties
      const releaseService = createReleaseService({ balerion: baseBalerionMock });
