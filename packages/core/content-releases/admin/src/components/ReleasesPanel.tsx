import { useRBAC, useQueryParams } from '@balerion/admin/balerion-admin';
...
import type { PanelComponent, PanelComponentProps } from '@balerion/content-manager/balerion-admin';
...
const Panel: PanelComponent = ({
  ...
  if (!window.balerion.isEE || !options?.draftAndPublish || !canRead) {
    return null;
  }
