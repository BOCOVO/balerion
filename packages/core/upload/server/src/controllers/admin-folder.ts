...
export default {
  async findOne(ctx: Context) {
    ...
    const { results } = await balerion.db.query(FOLDER_MODEL_UID).findPage(
      balerion.get('query-params').transform(
        FOLDER_MODEL_UID,
        defaultsDeep(
          {
            filters: { id },
  ...
  async find(ctx: Context) {
    ...
    const results = await balerion.db.query(FOLDER_MODEL_UID).findMany(
      balerion.get('query-params').transform(
        FOLDER_MODEL_UID,
        defaultsDeep(
          {
