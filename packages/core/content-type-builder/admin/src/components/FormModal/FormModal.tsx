...
import { useBalerionApp, useTracking, useNotification } from '@balerion/admin/balerion-admin';
...
export const FormModal = () => {
  ...
  const getPlugin = useBalerionApp('FormModal', (state) => state.getPlugin);
  const getCustomField = useBalerionApp('FormModal', (state) => state.customFields.get);
