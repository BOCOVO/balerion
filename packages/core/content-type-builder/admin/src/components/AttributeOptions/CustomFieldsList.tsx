import { useBalerionApp } from '@balerion/admin/balerion-admin';
...
export const CustomFieldsList = () => {
  ...
  const getAllCustomFields = useBalerionApp('CustomFieldsList', (state) => state.customFields.getAll);
  ...
  return (
    <KeyboardNavigable tagName="button">
      <Flex direction="column" alignItems="stretch" gap={3}>
        ...
        <Link
          href="https://docs.balerion.io/developer-docs/latest/development/custom-fields.html"
          isExternal
        >
          {formatMessage({
