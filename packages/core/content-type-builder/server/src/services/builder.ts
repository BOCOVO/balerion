...
export const reservedAttributes = [
  // TODO: these need to come from a centralized place so we don't break things accidentally in the future and can share them outside the CTB, for example on Balerion bootstrap prior to schema db sync
  ...
  // Used for Balerion functionality
  'entry_id',
  'status',
  'localizations',
  'meta',
