...
export const createComponent = async ({ component, components = [] }: any) => {
  ...
  balerion.eventHub.emit('component.create', { component: newComponent });
...
export const editComponent = async (
  ...
  balerion.eventHub.emit('component.update', { component: updatedComponent });
...
export const deleteComponent = async (uid: Internal.UID.Component) => {
  ...
  balerion.eventHub.emit('component.delete', { component: deletedComponent });
