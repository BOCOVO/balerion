...
import { LocalSave } from '../services/balerion-info-save';
...
async function getProjectsList(
  ...
  try {
    ...
    if (!Array.isArray(projectList)) {
      ctx.logger.log("We couldn't find any projects available for linking in Balerion Cloud.");
      return null;
    }
    ...
    spinner.fail('An error occurred while fetching your projects from Balerion Cloud.');
