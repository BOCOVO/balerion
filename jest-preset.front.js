...
const moduleNameMapper = {
  '.*\\.(css|less|styl|scss|sass)$': '@balerion/admin-test-utils/file-mock',
  '.*\\.(jpg|jpeg|png|gif|eot|otf|webp|svg|ttf|woff|woff2|mp4|webm|wav|mp3|m4a|aac|oga|ico)$':
    '@balerion/admin-test-utils/file-mock',
  /**
...
module.exports = {
  ...
  globalSetup: '@balerion/admin-test-utils/global-setup',
  setupFiles: ['@balerion/admin-test-utils/setup'],
  setupFilesAfterEnv: ['@balerion/admin-test-utils/after-env'],
  testEnvironment: '@balerion/admin-test-utils/environment',
