...
description: API reference for the useDocumentActions hook from Balerion's Content Manager
tags:
  - content-manager
  - hooks
  - public API
...
used anywhere within a Balerion app. The hooks will handle notifications should the operation fail,
