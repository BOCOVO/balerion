---
title: useDocument
description: API reference for the useDocument hook from Balerion's Content Manager
tags:
  - content-manager
  - hooks
  - public API
...
If you're using this in the Balerion Content-Manager package, it is preferable to import `useDoc` instead.
...
```ts
import type { Attribute } from '@balerion/balerion';
