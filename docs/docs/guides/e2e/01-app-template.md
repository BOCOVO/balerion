...
:::info
The app template should be realistic and structured in a way an actual user might create an app using Balerion
:::
...
balerion. When enabled login requests for each user are limitted to 5 in 5 minutes.
...
true a browser window will open each time you run the e2e tests as the balerion
