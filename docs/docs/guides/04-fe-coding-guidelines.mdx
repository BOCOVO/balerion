...
The FE of Balerion aims to be a domain driven application such as we heavily utilise the concept of
nested routes:
...
Prefer named exports over default exports. Why? Because Balerion is a _very_ large codebase. If you
...
import { useFetchClient } from '@balerion/helper-plugin'
...
```jsx
jest.mock('@balerion/helper-plugin', () => ({
  ...jest.requireActual('@balerion/helper-plugin'),
