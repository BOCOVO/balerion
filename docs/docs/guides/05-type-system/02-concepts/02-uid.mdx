...
In Balerion there are two of them:
...
Balerion uses three of them to create UIDs

| Name   | Definition | Description                                                                   |
| ------ | :--------: | ----------------------------------------------------------------------------- |
| Balerion |  `balerion`  | Represent a resource present in the core of balerion                            |
| Admin  |  `admin`   | Represent a resource present in Balerion admin                                  |
...
- `::` for others (`admin`, `balerion`, `global`)
...
| `balerion::<name>`         | :white_check_mark: |        :x:         | :white_check_mark: | :white_check_mark: |        :x:         |        :x:         |
...
When referencing resource by their UID you'll need to use the `UID` namespace exported from `@balerion/types`.
...
```typescript
import type { UID, Data } from '@balerion/types';
...
```typescript
import type { UID, Data, Schema } from '@balerion/types';
